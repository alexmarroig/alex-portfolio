export default function AIOpsAssistant() {
  return (
    <>
      <h1 style={{ fontSize: 26, marginBottom: 6 }}>AI Ops Assistant — Workflow Automation for Enterprise Teams</h1>
      <p style={{ opacity: 0.8, marginTop: 0 }}>
        Public portfolio project — designed to showcase applied AI + process automation (no proprietary IP).
      </p>
